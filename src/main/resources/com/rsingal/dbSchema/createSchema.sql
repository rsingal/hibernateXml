...
CREATE TABLE "EMPLOYEE" 
	(	"ID_EMPLOYEE" NUMBER(10,0) NOT NULL ENABLE, 
		...
		"FK_ADDRESS" NUMBER(10,0) NOT NULL ENABLE, 
		"FK_COMPANY" NUMBER(10,0) NOT NULL ENABLE, 
		CONSTRAINT "EMPLOYEE_PK" PRIMARY KEY ("ID_EMPLOYEE"),
		CONSTRAINT "EMPLOYEE_FK1_ADDRESS" FOREIGN KEY ("FK_ADDRESS") REFERENCES "ADDRESS" ("ID_ADDRESS") ON DELETE CASCADE ENABLE, 
		CONSTRAINT "EMPLOYEE_FK1_COMPANY" FOREIGN KEY ("FK_COMPANY") REFERENCES "COMPANY" ("ID_COMPANY") ON DELETE CASCADE ENABLE
	);
-- **********************************************************************
-- Table ACCOUNT
-- **********************************************************************
CREATE TABLE "ACCOUNT"
	(	"ID_ACCOUNT" NUMBER(10,0) NOT NULL ENABLE, 
		...
		"FK_EMPLOYEE" NUMBER(10,0), 
		CONSTRAINT "ACCOUNT_PK" PRIMARY KEY ("ID_ACCOUNT"),
		CONSTRAINT "ACCOUNT_UK1_BANK_NAME_ACCT_NO" UNIQUE ("BANK_NAME", "ACCOUNT_NUMBER"),
		CONSTRAINT "ACCOUNT_FK1_EMPLOYEE" FOREIGN KEY ("FK_EMPLOYEE") REFERENCES "EMPLOYEE" ("ID_EMPLOYEE") ON DELETE CASCADE ENABLE
	);
-- **********************************************************************
-- Table TRAINING
-- **********************************************************************
...
CREATE TABLE "EMP_TRNG_MAPPING" 
	(	"FK_EMPLOYEE" NUMBER(10,0) NOT NULL ENABLE, 
		"FK_TRAINING" NUMBER(10,0) NOT NULL ENABLE, 
		CONSTRAINT "EMP_TRNG_MAPPING_PK" PRIMARY KEY ("FK_EMPLOYEE", "FK_TRAINING"),
		CONSTRAINT "EMP_TRNG_MAPPING_FK1_TRAINING" FOREIGN KEY ("FK_TRAINING") REFERENCES "TRAINING" ("ID_TRAINING") ON DELETE CASCADE ENABLE, 
		CONSTRAINT "EMP_TRNG_MAPPING_FK1_EMPLOYEE" FOREIGN KEY ("FK_EMPLOYEE") REFERENCES "EMPLOYEE" ("ID_EMPLOYEE") ON DELETE CASCADE ENABLE
	);
-- **********************************************************************
...
CREATE TABLE "EMP_TRNG_MAPPING_EXTENDED" 
	(	"FK_EMPLOYEE" NUMBER(10,0) NOT NULL ENABLE, 
		...
		CONSTRAINT "EMP_TRNG_MAPPING_EXTENDED_PK" PRIMARY KEY ("FK_EMPLOYEE", "FK_TRAINING"),
		CONSTRAINT "EMP_TRNG_MAPPING_EXTENDED_FK1" FOREIGN KEY ("FK_EMPLOYEE") REFERENCES "EMPLOYEE" ("ID_EMPLOYEE") ON DELETE CASCADE ENABLE, 
		CONSTRAINT "EMP_TRNG_MAPPING_EXTENDED_FK2" FOREIGN KEY ("FK_TRAINING") REFERENCES "TRAINING" ("ID_TRAINING") ON DELETE CASCADE ENABLE
	);
